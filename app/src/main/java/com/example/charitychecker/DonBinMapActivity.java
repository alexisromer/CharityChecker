...
public class DonBinMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void getZipGeo(String zip, final DonBinMapActivity.VolleyCallBack callBack){
        String tag = "geoCode";
    ...
    public void donBoxQuery(String zip, final DonBinMapActivity.VolleyCallBack callBack){
        // create queue object
        RequestQueue queue;
        queue = Volley.newRequestQueue(this);
        ...
        String myUrl = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?keyword=donate+clothes&location=" + theLat +"%2C" + theLong + "&radius=10000" + auth;
    ...
    public void pre(GoogleMap googleMap, String zip, final DonBinMapActivity.VolleyCallBack callBack){
        getZipGeo(zip, new DonBinMapActivity.VolleyCallBack(){
            @Override
            public void onSuccess() {
                donBoxQuery(zip, new DonBinMapActivity.VolleyCallBack() {
                    @Override
                    public void onSuccess() {
                        callBack.onSuccess();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap = googleMap;
        pre(mMap, zipCode, new DonBinMapActivity.VolleyCallBack(){
            @Override
            public void onSuccess(){
